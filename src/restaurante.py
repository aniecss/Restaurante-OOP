...
class Restaurante:
    ...
    def listar_restaurantes(cls):
        ...
        for restaurante in cls.restaurantes:
            print(
                f'{restaurante._nome.ljust(25)} | {restaurante._categoria.ljust(25)} | {f"{restaurante.media_avaliacoes:.1f}".ljust(25)} | {restaurante.ativo}')
    ...
    def media_avaliacoes(self):
        ...
        qnt_nota = len(self._avaliacao)
        media = round(soma_nota / qnt_nota, 1)
        return media
